...
%else
    %if ! 0%{?commit:1}
        %global commit     c1c235449844a4f72fc2465cb700bafff7a0a933
    %endif
    %if ! 0%{?commit_date:1}
        %global commit_date 20200714
    %endif
...
%endif
%if %{with python2}
# unversioned executables must be the python2 version if shipping with python2
...
%else
ln -s avocado-%{python3_version} %{buildroot}%{_bindir}/avocado
ln -s avocado-rest-client-%{python3_version} %{buildroot}%{_bindir}/avocado-rest-client
%endif
pushd optional_plugins/html
%if %{with_python2}
%py2_install
...
%changelog
* Tue Jul 14 2020 Cleber Rosa <cleber@redhat.com> - 69.3-0
- New release
